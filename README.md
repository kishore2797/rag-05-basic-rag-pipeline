...
> Previous: [04 — Vector Stores](https://github.com/BellaBe/rag-04-vector-stores) | Next: [06 — Wikipedia Chatbot](https://github.com/BellaBe/rag-06-wikipedia-chatbot)
...
You've built a basic RAG pipeline. Head to **[Tutorial 06 — Wikipedia Chatbot](https://github.com/BellaBe/rag-06-wikipedia-chatbot)** to see RAG applied to live, dynamic data sources.
